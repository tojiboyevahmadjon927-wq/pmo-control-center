...
if ($resp.ok) {
    ...
    Write-Host "  Метрики Турон Телеком успешно обновлены на VPS!" -ForegroundColor Green
    Write-Host "  Откройте вкладку Метрики и обновите страницу (Ctrl+F5)." -ForegroundColor Green
    Write-Host "================================================" -ForegroundColor Green
} else {
